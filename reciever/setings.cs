...
namespace reciever
{
    public partial class setings : Form
    {
        ...
        private void timer3_Tick(object sender, EventArgs e)
        {
            ...
            using (FileStream fsInput = File.OpenRead(@"C:\Program Files\Common Files\PS Shared\Database\WELLSITEDB.mdb"))
            {
                using (FileStream fsOutput = File.Create(@"C:\Program Files\Common Files\PS Shared\Database\WELLSITEDB.zip"))
                {
